...
from config import COLOR_BACKGROUND, COLOR_FLOOR, COLOR_WALL, COLOR_EXIT, COLOR_PLAYER
...
class GameRenderer:
    ...
    def render_frame(self, floors: List[pygame.Rect], walls: List[pygame.Rect], player, exit_pos: Tuple[float, float]):
        self.clear()
